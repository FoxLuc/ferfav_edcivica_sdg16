...
@Component({
  selector: 'app-bribery-nation',
  templateUrl: './bribery-nation.component.html',
  styleUrls: ['./bribery-nation.component.css']
})
export class BriberyNationComponent implements OnInit {
  ...
  getRouterParam = (params: ParamMap) => {
    ...
    console.log(name)
    this.SDG16ServiceObs = this.service.getGeoAreaNameBribery(name);
    this.SDG16ServiceObs.subscribe(
      (data) => {
        this.nazione = data[0];
        console.log(this.nazione);
        this.title = 'Incidenza di Corruzione';
        this.type = 'BarChart';
        this.data =
          [
