...
@Component({
  selector: 'app-expense-nation',
  templateUrl: './expense-nation.component.html',
  styleUrls: ['./expense-nation.component.css']
})
export class ExpenseNationComponent implements OnInit {
  ...
  getRouterParam = (params: ParamMap) => {
    ...
    console.log(name)
    this.SDG16ServiceObs = this.service.getGeoAreaNameExpense(name);
    this.SDG16ServiceObs.subscribe(
      (data) => {
        this.nazione = data[0];
        console.log(this.nazione);
        this.title = 'Gestione Budget';
        this.type = 'BarChart';
        this.data =
          [
